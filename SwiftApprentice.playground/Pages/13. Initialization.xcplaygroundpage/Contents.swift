...
// Setting default value using a closure

class Counter {
    // Now here, we dont just give static value, and this is not like stored property willSet or computed property thing, its different, {} within these it has logic for value but here for simplicity we are use a simple let, and return it, then () this tells swift to execute it and use this value
    // Normal Stored
//    var s: Int = 1 {
//        willSet {
//            
...
//    }
    ...
    var startValue: Int = {
        // Imagine this value could be based on some calculation.
        // For simplicity, we're just returning a constant value.
        let initialValue = 10
        return initialValue
    }()
}
